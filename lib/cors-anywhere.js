...
function withCORS(headers, request) {
  headers['access-control-allow-origin'] = 'https://next-js-client-for-next-laravel.vercel.app';
...
exports.createServer = function createServer(options) {
  ...
  proxy.on('error', function(err, req, res) {
    ...
    res.writeHead(404, {'Access-Control-Allow-Origin': 'https://next-js-client-for-next-laravel.vercel.app'});
